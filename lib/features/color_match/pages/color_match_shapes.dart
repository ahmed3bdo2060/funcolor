...
class _ColorMixingSamplsState extends State<ColorMatchShapes> {
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Stack(
                  children: [
                    // Target containers
                    _buildTargetContainer(AppImages.emptyOrangColorMatchShapes, 0, 0, Color(0xffF57615)),
                    _buildTargetContainer(AppImages.emptyBlueColorMatchShapes, 174.w, 0, Color(0xff0FA6DB)),
                    _buildTargetContainer(AppImages.emptyPurpleColorMatchShapes, 174 * 2.w, 0, Color(0xffC373D6)),
                    _buildTargetContainer(AppImages.emptyGreenColorMatchShapes, 174 * 3.w, 0, Color(0xff78C843)),
                    _buildTargetContainer(AppImages.emptyYellowColorMatchShapes, 174 * 4.w, 0, Color(0xffFFB700)),
                    _buildTargetContainer(AppImages.emptyRedColorMatchShapes, 174 * 5.w, 0, Color(0xffD74143)),
                    ...
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Stack(
                          children: [
                            _buildDraggableCircle(Color(0xffF57615), 0.w, 0.h),
                            _buildDraggableCircle(Color(0xff0FA6DB), 75.w, -49.h),
                            _buildDraggableCircle(Color(0xffC373D6), 101.w, 55.h),
                            _buildDraggableCircle(Color(0xffD74143), 101.w, 0.h),
                            _buildDraggableCircle(Color(0xffFFB700), 75.w, 20.h),
                            _buildDraggableCircle(Color(0xff78C843), 15.w, 37.h),
                          ],
                        ),
                      ),
                    )
  ...
  Widget _buildTargetContainer(String image, double offsetX, double offsetY, Color targetColor) {
        ...
        builder: (context, candidateData, rejectedData) {
          return Container(
            ...
            child: SvgPicture.asset(
              ...
              height: 220,
              width: 220,
              color: colorMatched[_getColorName(targetColor)] == true ? targetColor : null,
            ),
